...
function zerif_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<h2 class="screen-reader-text"><?php _e( 'Posts navigation', 'womoz-brasil' ); ?></h2>

		<div class="nav-links">

			<?php if ( get_next_posts_link() ) : ?>

			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Postagens Antigas', 'womoz-brasil' ) ); ?></div>

			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>

			<div class="nav-next"><?php previous_posts_link( __( 'Postagens recentes <span class="meta-nav">&rarr;</span>', 'womoz-brasil' ) ); ?></div>
...
function zerif_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<h2 class="screen-reader-text"><?php _e( 'Post navigation', 'womoz-brasil' ); ?></h2>

		<div class="nav-links">

			<?php

				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="meta-nav">&larr;</span> %title', 'Post anterior', 'womoz-brasil' ) );

				next_post_link(     '<div class="nav-next">%link</div>',     _x( '%title <span class="meta-nav">&rarr;</span>', 'Próximo post',     'womoz-brasil' ) );
...
function zerif_posted_on() {
	...
	printf( __( '<span class="posted-on">Publicado em %1$s</span><span class="byline"> por %2$s</span>', 'womoz-brasil' ),
